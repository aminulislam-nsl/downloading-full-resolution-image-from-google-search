...
This will enable you to execute JavaScript in a REPL-like manner
The next step is to start scrolling!
Keep scrolling until you have found all relevant images to your query
From there, we manually intervene with JavaScript.
Switch back to the JavaScript console and copy + paste the following function
into the console to simulate a right click on an image: */
